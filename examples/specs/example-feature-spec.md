...
| Surface | Notes |
|---|---|
| UI | Example-item form and list |
| API | Create and load example item |
| Data | Persist owner, name, and example payload |
| Security/privacy | Ownership check |
...
- [ ] Error recovery
- [ ] End-to-end coverage for critical cross-layer journeys
